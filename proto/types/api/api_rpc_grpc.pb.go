...
const (
	ApiService_CreateApi_FullMethodName = "/api.ApiService/CreateApi"
	ApiService_GetApi_FullMethodName    = "/api.ApiService/GetApi"
	ApiService_UpdateApi_FullMethodName = "/api.ApiService/UpdateApi"
	ApiService_DeleteApi_FullMethodName = "/api.ApiService/DeleteApi"
	ApiService_ListApis_FullMethodName  = "/api.ApiService/ListApis"
)
