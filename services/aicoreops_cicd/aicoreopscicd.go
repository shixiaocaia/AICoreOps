...
var configFile = flag.String("f", "etc/aicoreopscicd.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		aicoreops_cicd.RegisterAicoreopsCicdServer(grpcServer, server.NewAicoreopsCicdServer(ctx))
