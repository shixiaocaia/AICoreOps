...
type User struct {
	...
	PasswordSalt  string `gorm:"column:password_salt;type:varchar(50)" json:"password_salt"`        // 密码盐
	...
	LastLoginTime int    `gorm:"column:last_login_time;type:int" json:"last_login_time"`           // 最后登录时间
	CreateTime    int    `gorm:"column:create_time;type:int;autoCreateTime" json:"create_time"`    // 创建时间
	UpdateTime    int    `gorm:"column:update_time;type:int;autoUpdateTime" json:"update_time"`    // 更新时间
